<x-app-layout>
    ...
    <body>
        ...
        <div class="items-container">
            ...
            {{-- keresés szavának eredményeinek kilistázása --}}
            @if($items->isEmpty())
        ...
        <div class="flex justify-between items-center mt-6">
            <form method="GET" action="{{ route('search') }}">
                ...
                {{-- search query eltárolása, hogy tovább tudjuk küldeni --}}
            ...
            {{-- Lapozás oldalak számainak megjelenítése - ebben az esetben a search queryt is tovább küldi hogy megmaradjon a keresés --}}
