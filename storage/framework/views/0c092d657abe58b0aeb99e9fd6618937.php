...
<?php $component->withAttributes([]); ?>
    ...
    <?php if(Route::currentRouteName() == 'onsale'): ?>
        <title>On Sale</title>
    <?php else: ?>
        <title>Home</title>
    <?php endif; ?>
    ...
    <body>
        ...
        <div class="flex justify-between items-center mt-6">
            <form method="GET"
                ...
                <?php if(Route::currentRouteName() == 'onsale'): ?>
                    action="<?php echo e(route('onsale')); ?>"
                <?php else: ?>
            ...
            <?php echo e($items->appends(['per_page' => request('per_page')])->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\teme3\OneDrive\Herd\marianna-present\resources\views\welcome.blade.php ENDPATH**/ ?>