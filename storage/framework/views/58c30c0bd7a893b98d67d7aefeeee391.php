...
$__html = app('livewire')->mount($__name, $__params, 'lw-3990153249-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
            ...
            <?php if(\App\Models\Order::where('user_id', auth()->id())->exists()): ?>
                <div class="mt-10 sm:mt-0">
                    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('profile.orders-user');

$__html = app('livewire')->mount($__name, $__params, 'lw-3990153249-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3990153249-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3990153249-3', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3990153249-4', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3990153249-5', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\Users\teme3\OneDrive\Herd\marianna-present\resources\views\profile\show.blade.php ENDPATH**/ ?>